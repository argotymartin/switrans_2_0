...
Future<void> initializeDependencies() async {
  ...
  injector.registerSingleton<TransaccionContableApi>(TransaccionContableApi(injector()));
  injector.registerSingleton<AbstractTransaccionContableRepository>(TransaccionContableRepositoryApiImpl(injector()));
